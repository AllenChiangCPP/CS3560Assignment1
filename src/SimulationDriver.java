...
public class SimulationDriver {
       public static void main(String[] args) {
              ...
              Question TESTQuestion = new Question("This answer will be F. T/F", true);
              VotingService votingService3 = new VotingService(TESTQuestion, "Invalid");
              ...
              //code for testing votingService's acceptSubmission method for replacing a student's answer, should print that ther eis 1 F
              Student studentTEST = new Student("StudentTEST");
              studentTEST.submitAnswer("T");
              votingService3.acceptSubmission(studentTEST);
              studentTEST.submitAnswer("F");
              votingService3.acceptSubmission(studentTEST);
              votingService3.printResults();
       }
}
